...
| ------ | ------ | ------ | ------ | ------ |
| currentPasswordEntropy | Yes | 0 | any positive int | current entropy for password which you enter ( post request to account **password/validate**)  |
| minPasswordEntropy | Yes | 0 | any positive int | minimal entropy required by password ( Setting on **account.env**  ) |
