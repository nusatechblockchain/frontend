                        ...
                        <React.Fragment>
                            <div className="setup-screen__left">
                                <SetupInfoBlock
                                    ...
                                    description="XLN is a liquidity network by Nusatech. Everyone can join it by deploying the NusaExchange platform or integrating with our APIs. XLN provides aggregated liquidity and creates a beneficial environment for all market participants"
                                />
                            </div>
                            <div className="setup-screen__right">
                                <div className="setup-screen__right-wrapper">
                        ...
                        <React.Fragment>
                            <div className="setup-screen__left">
                                <SetupInfoBlock
                                    ...
                                    title="Welcome to NusaExchange software"
                                    description=""
                                />
                            </div>
                            <div className="setup-screen__right">
